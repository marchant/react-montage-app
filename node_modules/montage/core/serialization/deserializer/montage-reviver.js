        ...
        value: function (value, context, label) {
            ...
            if ("value" in value) {
                ...
                if (this.getTypeOf(value.value) === "Element") {
                    var oldDataset = revivedValue.dataset;

                    Object.defineProperty(revivedValue, "dataset", {
                        value: new Proxy(Object.create(null), {
                            set: function (target, propertyName, value) {
                                revivedValue.setAttribute('data-' + propertyName, value);
                    ...
                    var propertyNames = Object.keys(oldDataset),
                        propertyName;

                    for (var i = 0, length = propertyNames.length; i < length; i++) {
                        propertyName = propertyNames[i];
                        revivedValue.dataset[propertyName] = oldDataset[propertyName];
                    }
